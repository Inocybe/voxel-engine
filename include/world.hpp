...
public:
    ...
    std::queue<std::tuple<int, int, int>> chunkGenerationQueue; // queue of chunk coordinates to generate, used to store the chunks that need to be generated, so that they can be generated by the mesh worker thread
